...
public class EditarLivro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pratileira = request.getParameter("pra");
        String sessao = request.getParameter("ses");

        Livro l = new Livro (nome, autor,ano ,sessao,genero,pratileira );
        l.setId(id);
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditarLivro</title>");            
            out.println("</head>");
            out.println("<body>");
